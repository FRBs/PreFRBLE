...
##        RM.extend( np.sum( 0.81*1e3*dx*rho*B[i_ax] * i_ax, axis=i_ax ) ) 
...
#PlotUniformProbability( ['primordial', 'primordial2R', 'primordial3R', 'astrophysical', 'astrophysicalR', 'astrophysical1R' ], range=(1e-1,1e4), density=True) #, posneg=True )# , density=False )
